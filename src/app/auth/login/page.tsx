        ...
        <main className="min-h-screen bg-[#f7faf4] flex items-center justify-center p-6">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-black text-[#2c342e] mt-6 mb-1">Tekrar hoş geldin</h1>
                    <p className="text-sm text-[#59615a]">Hesabına giriş yap, kaldığın yerden devam et.</p>
                </div>
                ...
                <div className="text-center mt-6 space-y-2">
                    <p className="text-sm text-[#59615a]">
                        Hesabın yok mu?{' '}
                        <Link href="/auth/register" className="text-[#386948] font-bold hover:underline">
                            Ücretsiz kayıt ol
                        </Link>
                    </p>
