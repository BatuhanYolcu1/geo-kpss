...
export const flashcardDecks: FlashcardCategory[] = [
    ...
    // ─── 2. YER ŞEKİLLERİ ───────────────────────────────────────
    {
        ...
        cards: [
            ...
            { id: 'fc-012', front: 'Türkiye\'nin en yüksek noktası ve türü?', back: 'Ağrı Dağı — 5137 m — Volkanik (söndük)\nSonraki: Cilo Dağı (4135 m, Hakkari), Süphan (4058 m, volkanik), Kaçkar (3937 m, kıvrım)\n(Dikkat: 2. en yüksek Süphan değil, Cilo Dağı\'dır — sık karıştırılır!)', difficulty: 'easy', category: 'yer-sekilleri' },
    ...
    // ─── 8. NÜFUS VE YERLEŞİM ───────────────────────────────────
    {
        ...
        cards: [
            ...
            { id: 'fc-086', front: '"Demografik dönüşüm"ün 4 evresi nelerdir?', back: '1. Evre: Doğum yüksek, ölüm yüksek → nüfus sabit\n2. Evre: Ölüm düşüyor, doğum yüksek → nüfus patlaması\n3. Evre: Doğum da düşüyor → büyüme yavaşlıyor\n4. Evre: İkisi de düşük → nüfus sabit (gelişmiş ülkeler)\nTürkiye günümüzde 3. evrenin sonundadır.', difficulty: 'hard', category: 'nufus' },
            { id: 'fc-087', front: 'Türkiye\'de nüfus artış hızının (‰) tarihsel seyri?', back: '1950-1980: ‰25-30 (yüksek — "Cumhuriyet bebek patlaması")\n1980-2000: ‰15-20 (düşüyor)\n2000-2020: ‰10-12 (belirgin yavaşlama)\n2020+: ‰5 civarı — sona yaklaşıyor', difficulty: 'medium', category: 'nufus' },
            { id: 'fc-088', front: 'Türkiye\'de "çizgisel yerleşme" nerede ve neden görülür?', back: 'Karadeniz kıyılarında. Arkadaki sarp dağlar nüfusu dar kıyı şeridine sıkıştırır. Yollar, yerleşmeler ve tarım alanları kıyıya paralel uzanır.', difficulty: 'medium', category: 'nufus' },
            { id: 'fc-089', front: 'Köy altı yerleşme birimlerini sayın.', back: '• Mezra: Köye bağlı küçük tarım/hayvancılık birimi\n• Ağıl / Kom: Hayvancılık için geçici barınak\n• Yayla: Yaz mevsiminde kullanılan yüksek alan\n• Dalyan: Balıkçılık için kıyıda kurulan birim', difficulty: 'medium', category: 'nufus' },
            { id: 'fc-086b', front: 'Türkiye\'de göç veren ve göç alan başlıca bölgeler?', back: 'Göç ALAN (net pozitif):\n• Marmara (İstanbul, Kocaeli, Bursa)\n• Akdeniz (Antalya), Ege (İzmir)\n\nGöç VEREN (net negatif):\n• Karadeniz, Doğu Anadolu, GDA', difficulty: 'medium', category: 'nufus' },
        ],
    },
    ...
    // ─── 9. ÇEVRE VE DOĞAL AFETLER ──────────────────────────────
    {
        ...
        cards: [
            ...
            { id: 'fc-096', front: 'İklim değişikliğinin Türkiye\'ye beklenen etkileri nelerdir?', back: '• Sıcaklık artışı: Akdeniz havzası %1-2°C daha sıcak\n• Yağış azalması: İç Anadolu ve GDA kuraklaşıyor\n• Deniz seviyesi yükselmesi: İstanbul, İzmir deltaları risk altında\n• Tarım verimi değişimi: Güneyden kuzeye kayış', difficulty: 'hard', category: 'cevre-afetler' },
            { id: 'fc-097', front: 'Türkiye\'de orman yangınlarının en çok yaşandığı bölge ve nedeni?', back: 'Akdeniz ve Ege kıyıları. Neden: Kuru yazlar (Akdeniz iklimi) + kızılçam ormanlarının tutuşganlığı. En yıkıcı yıllar: 2021 (Antalya/Muğla).', difficulty: 'medium', category: 'cevre-afetler' },
            { id: 'fc-098', front: 'Türkiye\'de hava kirliliği en yüksek şehirler ve sebepleri?', back: 'En kirli: Ankara (kapalı hava havzası + konut ısınması), İstanbul (trafik + sanayi), Bursa (sanayi).\nPM10 ve PM2.5 kriterlerini en çok aşan il: Ankara.', difficulty: 'medium', category: 'cevre-afetler' },
            { id: 'fc-099', front: 'Türkiye\'de hangi deprem kuşakları var? Risk haritası?', back: '1. derece deprem bölgesi: Marmara, Kuzey Anadolu, Doğu Anadolu\n2. derece: Ege kıyıları, Karadeniz kıyısı\nEn güvenli: Orta Karadeniz (Kastamonu, Sinop), İç Anadolu bazı kesimler', difficulty: 'hard', category: 'cevre-afetler' },
            { id: 'fc-100', front: 'Toprak ve su kirliliğinin tarımdaki etkileri?', back: '• Tarım ilacı kirliliği: Ege ovalarında nitrat birikimi\n• Sanayi atıkları: Ergene nehri (Trakya) — tekstil atıkları\n• Tuzlanma: Konya, Harran ovası — aşırı sulama\n• Seralarda plastik kirliliği: Antalya çevresinde sorun', difficulty: 'hard', category: 'cevre-afetler' },
        ],
    },
    ...
    // ─── 10. TURİZM VE KÜLTÜREL MİRAS ──────────────────────────
    {
        ...
        cards: [
            { id: 'fc-050', front: 'Türkiye\'nin UNESCO Dünya Mirası sayısı ve örnekler?', back: '22 UNESCO mirası (20 kültürel, 2 karma). Örnekler:\n• İstanbul Tarihi Bölgeleri\n• Kapadokya (Göreme)\n• Pamukkale-Hierapolis\n• Efes (2015)\n• Göbeklitepe (2018)\n• Gordion (2023)\n• Sardes ve Bin Tepe Lidya Tümülüsleri (2025 — en yeni eklenenler)', difficulty: 'medium', category: 'turizm' },
            ...
            { id: 'fc-053', front: 'Türkiye\'nin turizm istatistikleri (güncel)?', back: '2025\'te rekor: ~64 milyon yabancı ziyaretçi, ~65,2 milyar dolar turizm geliri (TÜİK). En çok turist alan il: Antalya (~16-17,5 milyon). Dünya sıralamasında ziyaretçi sayısında 4., gelirde 7. sıradayız.', difficulty: 'medium', category: 'turizm' },
            ...
            { id: 'fc-056', front: 'Türkiye\'deki inanç turizmi merkezleri?', back: '• Meryem Ana Evi (Efes/İzmir) — Hristiyan\n• Tarsus (St. Paul\'un doğduğu yer) — Hristiyan\n• Antakya (İlk kilise) — Hristiyan\n• Göbeklitepe (Şanlıurfa) — Arkeolojik/manevi\n• Konya (Mevlana Türbesi) — İslam/Tasavvuf\n• Eyüp Sultan (İstanbul) — İslam', difficulty: 'medium', category: 'turizm' },
            { id: 'fc-057', front: 'Yayla turizmi nedir, hangi bölgelerde gelişmiştir?', back: 'Sıcaktan kaçmak için yüksek yaylalarda yapılan turizm.\n• Doğu Karadeniz: Ayder, Pokut, Sal, Kavrun yaylaları\n• Doğu Anadolu: Kaçkar çevresindeki yaylalar\nGeleneksel: Yaylaya çıkma kültürü hâlâ yaşıyor.', difficulty: 'easy', category: 'turizm' },
            { id: 'fc-058', front: 'Sağlık ve termal turizm merkezleri?', back: '• Afyonkarahisar: En çok termal tesis — Sandıklı, Ömerli\n• Yalova Termal\n• Bursa Çekirge\n• Kütahya Gediz\n• Türkiye, dünya sağlık turizmi gelirinde ilk 10\'da yer alıyor.', difficulty: 'medium', category: 'turizm' },
            { id: 'fc-059', front: 'Göbeklitepe neden dünya tarihinde çığır açıcıdır?', back: '• MÖ ~11.600 — bilinen en eski tapınak kompleksi\n• Tarım öncesi dönem (avcı-toplayıcı) insanlar yaptı\n• Bu bulgu "önce tarım, sonra din/kent" teorisini devirdi\n• Şanlıurfa\'da, UNESCO mirası (2018)', difficulty: 'hard', category: 'turizm' },
            { id: 'fc-059b', front: 'Turizm türlerini kısaca özetleyin (KPSS için).', back: '• Kültür: Efes, İstanbul, Göbeklitepe\n• Doğa: Kapadokya, Kaçkar, Olimpos\n• Kış: Uludağ, Palandöken, Erciyes\n• Yayla: Ayder, Pokut\n• Sağlık/Termal: Afyon, Yalova\n• İnanç: Meryem Ana, Mevlana, Tarsus\n• Mavi bayrak plaj (deniz-kum-güneş): Antalya, Muğla', difficulty: 'easy', category: 'turizm' },
        ],
    },
];
