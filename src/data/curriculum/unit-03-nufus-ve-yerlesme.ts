...
* **Yoğun Nüfuslu / Kalabalık Yerler ve Nedeni:**
  ...
  * **Doğu Karadeniz Kıyıları:** Özellikle Rize-Trabzon hattının *deniz seviyesindeki incecik kıyısı* tıklım tıklımdır. *Dikkat! Tüm Karadeniz değil, sadece kıyı şeridi yoğundur.* Çünkü arka o kadar sarp bir dağdır ki herkes denize inmek zorunda kalmıştır. (Çay tarımı vs). Buna **Çizgisel Yerleşme** denilir.`,
            ...
            keyPoints: [
                'Nüfusun %93,6\'sı kentlerde (il/ilçe merkezlerinde), %6,4\'ü kırlarda (belde ve köylerde) yaşar.',
...
| Gösterge | Değer |
|---------|-------|
| Toplam nüfus | **86.092.168** (2025, +427.224) |
| Nüfus artış hızı | **‰5** |
| Kentleşme oranı | **%93,6** (kırsal %6,4) |
| Medyan yaş | **34,9** (erkek 34,2 / kadın 35,7) |
| 65+ yaş oranı | **%11,1** (~9,58 milyon kişi) |
| En kalabalık il | **İstanbul: 15.754.053** (%18,3) |
| En genç il | **Şanlıurfa** (medyan yaş 21,8) |
| En yaşlı il | **Sinop** (medyan yaş 44) |
...
* Günümüzde medyan yaş 34,9'a yükseldi, nüfus yaşlanıyor.
* 65+ yaş oranı %11,1'e ulaştı (~9,58 milyon kişi, son 5 yılda %20,5 arttı) — sosyal güvenlik sistemi üzerinde artan baskı.
...
* **Sonuçları:**
    * Kentleşme oranı %93,6'ya yükseldi
...
* Türkiye 2000'li yıllardan itibaren kentsel dönüşüm projeleriyle gecekonduları yıkıp TOKİ konutlarıyla değiştirme politikası uygulamaktadır.`,
            ...
            keyPoints: [
                'Türkiye nüfusu: 86.092.168 (2025).',
                'Kentleşme oranı: %93,6.',
                'En kalabalık il: İstanbul (15,75 milyon, %18,3).',
                'En genç il: Şanlıurfa (medyan yaş 21,8) | En yaşlı il: Sinop (medyan yaş 44).',
                'Medyan yaş: 34,9 — nüfus yaşlanıyor.',
