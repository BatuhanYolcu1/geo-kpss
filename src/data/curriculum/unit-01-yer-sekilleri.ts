...
**Toros Dağları (Güney Anadolu):** Antalya körfezinden (Batı Toroslar) başlar. Beydağları, Geyik Dağları, Bolkar, Aladağlar (Orta Torosların ve kıvrımlı dağların en yüksek zirvesi - 3700m) ve Tahtalı dağlarıyla Güneydoğu'ya kıvrılır.
...
3. **Ria Kıyı Tipi:** Çok özeldir. Eskiden İstanbul M.Ö binlerce yıl önce akarsu vadisiydi. Deniz yükseldi (Epirojenezle Egeid çöktü), Marmara Denizi karanın boğaz yollarını doldurdu. Boğazların (İstanbul, Çanakkale), İstanbul Haliç'inin ve Muğla (Güneybatı Ege - Gökova körfezi) kıyılarının ismi Rij kıyı tipidir.
4. **Dalmaçya Kıyı Tipi:** Tıpkı Hırvatistan kıyıları gibi. Dağlar paraleldir ancak deniz o kadar yükselmiştir ki dağların vadileri su altında kalmış, tepeleri ise denizin ortasında sıram sıram küçük adacıklar halinde dizilmiştir. Türkiye'de sadece **Antalya (Kaş-Finike arası_** kıyılarında görülür.
5. **Kalanklı Kıyı:** Karstik (Kireçtaşı) arazilerde denizin yavaşça kayayı eritmesiyle oluşan kanyon gibi çok derin ama dar koylar. **Mersin - Silifke** civarında.`,
            keyPoints: [
                'Buzullar Türkiye şekillenmesinde en EKTİSİZ güçtür.',
